...
import gossipLearning.interfaces.models.kernels.Kernel;
import gossipLearning.interfaces.models.kernels.RBFKernel;
import gossipLearning.interfaces.models.losses.Loss;
...
public class NormaSVM implements LearningModel {
  ...
  protected static final int DEFAULT_TAU = 10;
  ...
  protected static final String DEFAULT_KERNEL = "gossipLearning.interfaces.models.kernels.LinearKernel";
  ...
  protected static final String DEFAULT_LOSS = "gossipLearning.interfaces.models.losses.SquaredLoss";
  ...
  public double predict(SparseVector x) {
    ...
    //return v;
    return v >= numberOfClasses -1 ? numberOfClasses -1 : Math.round(v);
  }
  ...
  private static double evaluate(LearningModel model, InstanceHolder evalSet) {
    double MAError = 0.0;
  ...
  public static void main(String[] args) throws Exception {
    if (args.length == 5 || args.length == 6 || args.length == 7) {
      ...
      DataBaseReader r = DataBaseReader.createDataBaseReader("gossipLearning.utils.DataBaseReader", new File(args[0]), new File(args[1]));

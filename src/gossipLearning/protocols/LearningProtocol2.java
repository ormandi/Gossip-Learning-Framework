...
public class LearningProtocol2 extends LearningProtocol {
  
  public LearningProtocol2(String prefix) {
    super(prefix);
  }
  
  protected LearningProtocol2(LearningProtocol2 a) {
    super(a);
  }
  
  @Override
  public Object clone() {
    return new LearningProtocol2(this);
  }

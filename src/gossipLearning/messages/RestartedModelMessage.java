...
public class RestartedModelMessage extends ModelMessage {
  private static final long serialVersionUID = 5621412036497937731L;

  private int restartedStepId;
  
  public RestartedModelMessage(Node src, ModelHolder models, int pid, boolean isDeep, int restartedStepId) {

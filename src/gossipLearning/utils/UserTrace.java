...
public class UserTrace {
  ...
  public UserTrace(Session[] sessions) {
  ...
  public UserTrace(Session[] sessions, Boolean firstOnline) {
    this.sessions = sessions;
    this.firstOnline = firstOnline;
  }

  public UserTrace(Session[] sessions, Boolean firstOnline, String userName, int timeZone, Long startDate) {

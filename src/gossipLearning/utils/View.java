...
/**
 * This is type designed for the &quot;Newscast&quoty; like protocols view implementation. Basically it is 
 ...
 * drawback. The real advantage of this implementation is the implementation of get operator which works in O(1).  
 * 
 * @author ormandi
 *
 ...
 */
public class View <T extends Cloneable<? super T> & Comparable<? super T>> implements Cloneable<View<T>>, Iterable<T> {
  ...
  public View(int length) {
    Cloneable<T>[] tmp = new Cloneable[length];
    this.view = (T[]) tmp;
  }
